...
const APP_DIR = '/Users/karmpatel/Desktop/POS System'
const SHOT_DIR = process.env.SCREENSHOT_DIR || '/Users/karmpatel/.claude/jobs/aedb6077/tmp/shots'
...
console.log('POS driver — "help" for commands, "launch" to start')
rl.prompt()
